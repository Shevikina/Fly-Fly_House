    ...
    Box(Modifier.width(381.dp))
    {
        ...
        Column(
            Modifier
                ...
                .background(
                    color = JetFlyFlyHouseTheme.colorScheme.surface,
                    shape = JetFlyFlyHouseTheme.shapes.dialog
                )
        ) {
            Column(
            ...
            Button(
                ...
                colors = ButtonDefaults.textButtonColors(
                    contentColor = JetFlyFlyHouseTheme.colorScheme.surface,
                    containerColor = JetFlyFlyHouseTheme.colorScheme.primary.copy(0.5f)
                ),
                modifier = Modifier
                    .fillMaxWidth()
                    .heightIn(min = 48.dp)
